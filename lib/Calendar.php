...
namespace SimpleCalendar {
    ...
    class Calendar {
         ...
         *
         * @param null|string $date_string Date string parsed by strtotime for
         *                                 the calendar date. If null set to
         *                                 current timestamp.
         */
        public function setDate(?string $date_string = NULL): void {
            if ($date_string) {
         ...
         *
         * @param string      $html              The raw HTML to place on the
         *                                       calendar for this event
         * @param string      $start_date_string Date string for when the event
         *                                       starts
         * @param null|string $end_date_string   Date string for when the event
         *                                       ends. Defaults to start date
         */
        public function addDailyHtml(string $html, string $start_date_string, ?string $end_date_string = NULL): void {
            static $htmlCount = 0;
         ...
         *
         * @param int|string $offset Day to start on, ex: "Monday" or 0-6 where
         *                           0 is Sunday
         */
         ...
         * @param int   $steps
         */
        private function arrayRotate(array &$data, $steps) :void {
            $count = count($data);
            if ($steps < 0) {
                $steps = $count + $steps;
            }
